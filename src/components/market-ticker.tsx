...
export function MarketTicker() {
    return (
        <div className="absolute top-0 left-0 right-0 z-[40] w-full bg-background/80 dark:bg-black/60 backdrop-blur-md border-b border-border/10 dark:border-white/5 h-10 flex items-center shadow-sm">
